<?php 
$title = "CSA signup in Redmond, OR organic farm | Dome Grown Produce";
...
?>
					...
					<div class="hero" id="hero">
						...
						<img src="photos/stormy-night-in-redmond-local-farms.jpg" alt="Produce for CSA shares in Redmond, OR">
